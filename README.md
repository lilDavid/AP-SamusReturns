...
For more information about the randomized game, see the
[docs page](src/msr/docs/en_Samus%20Returns.md).

For information about setting up a Samus Returns game, see the
[setup guide](src/msr/docs/setup_en.md).
