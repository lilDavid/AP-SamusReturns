...
class Area1(StrEnum):
    ...
    Bomb = "Bomb Chamber"
    InnerTempleEastHall = "Inner Temple East Hall"
    ...
    MetroidCavernsLobby = "Metroid Caverns Lobby"
    ...
    InnerTempleWestHall = "Inner Temple West Hall"
    CavernsSaveStation = "Metroid Caverns Save Station"
    TeleporterAccess = "Inner Temple Teleporter Access"
...
class Area2Interior(StrEnum):
    ...
    VariaInteriorIntersection = "Varia Suit Chamber & Interior Intersection Terminal"
...
class Area5Interior(StrEnum):
    ...
    TowerExteriorE = "Transport to Tower Exterior East"
...
class Area8(StrEnum):
    NestFoyer = "Metroid Nest Foyer & Hallway South"
