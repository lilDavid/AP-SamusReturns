...
location_table: dict[str, LocationData] = {
    ...
    make_name(SurfaceEast.Alpha, "Metroid"): MetroidLocationData(8, AreaId.SURFACE_EAST, "SG_Alpha_001"),
    ...
    make_name(Area1.ExteriorAlpha, "Metroid"): MetroidLocationData(107, AreaId.AREA_1, "SG_Alpha_004"),
    ...
    make_name(Area3Caverns.GammaS, "Metroid"): MetroidLocationData(316, AreaId.AREA_3_CAVERNS, "SG_Gamma_001"),
    ...
    make_name(Area3Interior.Alpha, "Metroid"): MetroidLocationData(332, AreaId.AREA_3_INTERIOR, "SG_Alpha_001"),
    ...
    make_name(Area4Caves.Alpha2, "Metroid"): MetroidLocationData(406, AreaId.AREA_4_CAVES, "SG_Alpha_001"),
    ...
    make_name(Area4Caves.Gamma, "Metroid"): MetroidLocationData(410, AreaId.AREA_4_CAVES, "SG_Gamma_001_A"),
    ...
    make_name(Area5Exterior.Gamma, "Metroid"): MetroidLocationData(521, AreaId.AREA_5_EXTERIOR, "SG_Gamma_003"),
